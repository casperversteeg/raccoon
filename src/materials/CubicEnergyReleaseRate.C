...
{
  _Gc[_qp] = _Gc0 * (1 + (_v[_qp] / _v_lim) * (_v[_qp] / _v_lim) * (_v[_qp] / _v_lim));
  _dGc_dv[_qp] = 3 * _Gc0 * (_v[_qp] / _v_lim) * (_v[_qp] / _v_lim) / _v_lim;
  _d2Gc_dv2[_qp] = 6 * _Gc0 * (_v[_qp] / _v_lim) / _v_lim / _v_lim;
}
